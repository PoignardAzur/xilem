...
Xilem evolved from various experiments in the Linebender community (Druid, crochet, masonry, idiopath, lasagna, etc).

An evolution of the ideas implemented in Xilem and Masonry can be found in the following resources:
